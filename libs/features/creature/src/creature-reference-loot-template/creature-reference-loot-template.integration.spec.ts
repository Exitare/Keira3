...
import { CreatureReferenceLootTemplateComponent } from './creature-reference-loot-template.component';
import { CreatureReferenceLootTemplateService } from './creature-reference-loot-template.service';
import Spy = jasmine.Spy;
import { instance, mock } from 'ts-mockito';

class CreatureLootTemplatePage extends MultiRowEditorPageObject<CreatureReferenceLootTemplateComponent> {}

describe('CreatureLootTemplate integration tests', () => {
  let fixture: ComponentFixture<CreatureReferenceLootTemplateComponent>;
  ...
  function setup(creatingNew: boolean, lootId = id) {
    spyOn(TestBed.inject(CreatureReferenceLootTemplateService), 'getLootId').and.returnValue(of([{ lootId }]));
    ...
    fixture = TestBed.createComponent(CreatureReferenceLootTemplateComponent);
